...
const imgDimensions = { width: 247 * 1.2, height: 325 * 1.2 };
...
image.src = "./assets/icanq.png";

const loopingIcanq = 40; 
...
function draw(offset, loopCount) {
  ...
  let currentPercentage = (loopingIcanq - loopCount) / loopingIcanq
  context.drawImage(
    image,
    -imgDimensions.width / 2 - offset/2 + (movementOffset.x * currentPercentage),
    -imgDimensions.height / 2 - offset/2 + (movementOffset.y * currentPercentage),
